            ...
            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 text-sm mt-1">Lengkapi informasi produk fashion Anda</p>
                </div>
                <button
        ...
        <div className="container mx-auto px-6 py-20 relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-gray-200">
              ...
              <span className="text-sm font-medium text-gray-700">Produk Fashion Lokal Terbaik</span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Temukan koleksi fashion terlengkap dari UMKM lokal dengan kualitas premium dan harga yang terjangkau
            </p>
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Koleksi <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Unggulan</span>
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Produk fashion pilihan yang sedang trending dari berbagai UMKM lokal terpercaya
          </p>
        </div>
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-xl p-6 text-center">
            ...
            <p className="text-red-800 font-medium">Terjadi kesalahan saat memuat produk</p>
      ...
      <section className="bg-gradient-to-r from-purple-50 to-pink-50 border-y border-purple-100">
        <div className="container mx-auto px-6 py-16">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                Tentang <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">StyleHub</span>
              </h2>
              <p className="text-gray-600 text-lg">Mendukung UMKM Fashion Indonesia</p>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Kami berkomitmen menghadirkan produk fashion berkualitas tinggi dengan bahan terbaik dan desain yang trendy.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20a3 3 0 01-3-3v-2a3 3 0 013-3h4a3 3 0 013 3v2a3 3 0 01-3 3z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-bold text-lg text-gray-900 mb-2">Mendukung UMKM Lokal</h3>
                    <p className="text-gray-600">Setiap pembelian Anda berkontribusi langsung untuk mendukung dan mengembangkan UMKM fashion Indonesia.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg text-gray-900 mb-2">Harga Terjangkau</h3>
                    <p className="text-gray-600">Dapatkan produk fashion berkualitas dengan harga yang ramah di kantong melalui platform kami.</p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                  <div className="grid grid-cols-2 gap-6 text-center">
                    <div>
                      ...
                      <div className="text-gray-600 text-sm">Produk Fashion</div>
                    </div>
                    <div>
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                Platform fashion terdepan yang menghubungkan UMKM lokal dengan customer di seluruh Indonesia. Wujudkan gaya impian Anda dengan produk berkualitas.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li><a href="/brands" className="hover:text-white transition-colors">Brand UMKM</a></li>
                <li><a href="/sale" className="hover:text-white transition-colors">Sale & Promo</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li><a href="/returns" className="hover:text-white transition-colors">Pengembalian</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} StyleHub - Platform Fashion UMKM Indonesia. All Rights Reserved.
            </p>
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <a href="/privacy" className="text-gray-400 hover:text-white text-sm transition-colors">Kebijakan Privasi</a>
              <a href="/terms" className="text-gray-400 hover:text-white text-sm transition-colors">Syarat & Ketentuan</a>
            </div>
          </div>
        </div>
      </footer>
