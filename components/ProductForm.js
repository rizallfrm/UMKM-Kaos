...
export default function ProductForm({ onSubmit }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (form.sizes.length === 0 || form.colors.length === 0) {
      console.log("Error: Ukuran/warna belum dipilih");
      alert("Harap pilih minimal 1 ukuran dan 1 warna");
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Buat produk fashion terbaru untuk toko UMKM Anda</p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-800">Informasi Produk</h2>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-2 h-8 bg-gradient-to-b from-pink-500 to-purple-600 rounded-full"></div>
                <h2 className="text-xl font-semibold text-gray-800">Gambar Produk</h2>
              </div>
